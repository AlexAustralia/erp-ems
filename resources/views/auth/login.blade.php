        ...
        <div class="row bs-reset">
            <div class="col-md-6 login-container bs-reset">
                ...
                <div class="login-content">
                    <h1>Steyr Motors ERP Login</h1>
                    <p> Please, input your email address and password to enter to the Steyr Motors ERP System</p>
                    ...
                    <div class="row bs-reset">
                        ...
                        <div class="col-xs-7 bs-reset">
                            <div class="login-copyright text-right">
                                <p>Copyright &copy; Steyr Motors 2016</p>
                            </div>
                        </div>
                    </div>
                </div>
